 ...
 *
 * Compiles React components from Raycast plugins into Lit components
 * Inspired by Vicinae's custom React reconciler architecture
 */
...
/**
 * React-likecreateElement function for building element trees
 */
