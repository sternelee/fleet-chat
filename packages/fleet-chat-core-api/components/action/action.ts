...
export class Action extends LitElement {
  ...
  private formatShortcut(shortcut: string | undefined): ReturnType<typeof html> {
...
export class ActionSeparator extends LitElement {
  static styles = css`
    :host {
      display: block;
      width: 100%;
...
declare global {
  interface HTMLElementTagNameMap {
    'fc-action': Action
    'fc-action-panel': ActionPanel
    'fc-action-separator': ActionSeparator
  }
}

export { Action as FCAction, ActionPanel as FCActionPanel, ActionSeparator as FCActionSeparator }
