...
export class Icon extends LitElement {
  ...
  private _renderImage() {
    return html`
      <div class="icon image">
        <img src="${this.source}" alt="${this.alt || 'Icon'}" @error=${this._handleImageError} />
      </div>
    `
  }
  ...
  private _getSymbolSVG(symbolName: string) {
    ...
    return symbolIcons[symbolName] || this._getLucideSVG(symbolName)
  }
  ...
  private _getLucideSVG(iconName: string): ReturnType<typeof html> {
    ...
    return html`${lucideIcons[iconName] || this.source}`
  }
  ...
  render() {
    ...
    let iconRender: ReturnType<typeof this._renderEmoji>
...
export class IconSymbol extends Icon {
  constructor() {
    super()
    this.type = 'symbol'
  }
...
export class IconText extends Icon {
  constructor() {
    super()
    this.type = 'text'
  }
...
declare global {
  interface HTMLElementTagNameMap {
    'fc-icon': Icon
    'fc-icon-symbol': IconSymbol
    'fc-icon-image': IconImage
    'fc-icon-text': IconText
  }
}
...
export type { IconSymbol, IconImage, IconText }

export { Icon as FCIcon, IconSymbol as FCIconSymbol, IconImage as FCIconImage, IconText as FCIconText }
