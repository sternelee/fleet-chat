...
class ToastManager {
  ...
  showToast(rootId: string, props: ToastProps, duration: number = 3000) {
    ...
    const toast = document.createElement('fc-toast') as Toast
    ...
    return html\`
      <div class="toast \${this.style || ''}">
        ...
        <div class="toast-content">
          ...
          \${ this.primaryAction || this.secondaryAction ? html\`
...
declare global {
  interface HTMLElementTagNameMap {
    'fc-toast': Toast
    'fc-toast-container': ToastContainer
  }
}

export { Toast as FCToast, ToastContainer as FCToastContainer }
