...
export class IconUtils {
  ...
  static detectIconType(source: string): IconType {
    ...
    if (/[\u{1F600}-\u{1F64F}]|[\u{2700}-\u{27BF}]|[\u{1F300}-\u{1F5FF}]|[\u{1F680}-\u{1F6FF}]|[\u{1F1E0}-\u{1F1FF}]/u.test(source)) {
      return "emoji";
    }
    ...
    const knownIcons = [
      "house", "home", "settings", "search", "user", "folder", "file",
      "chevron-right", "chevron-down", "chevron-up", "chevron-left",
      "plus", "minus", "check", "x", "heart", "star", "moon", "sun",
      // ... add more as needed
    ];
  ...
  static getInitialsColor(text: string): string {
    const colors = [
      ...
      "#F7DC6F", "#BB8FCE", "#85C1E2", "#F8B500", "#52C7B8"
    ];
