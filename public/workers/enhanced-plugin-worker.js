        ...
        default: async (_props) => {
          return createMockReactElement(
            ...
            createMockReactElement(
              'p',
              {},
              `Plugin has ${Object.keys(pluginData.code || {}).length} source files`,
            ),
            createMockReactElement(
              'p',
              {},
              'This is a placeholder UI. Full plugin execution coming soon!',
            ),
            createMockReactElement(
              'pre',
              {
                style:
                  'background: #f5f5f5; padding: 10px; border-radius: 4px; font-size: 12px; overflow: auto;',
